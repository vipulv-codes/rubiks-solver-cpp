...
public:
    ...
    /**
     * Returns the color of the cell at (row, col) on the given face.
     *
     * @param face The face of the cube (UP, LEFT, FRONT, RIGHT, BACK, DOWN).
     * @param row  The row index on the face (0 to 2, top to bottom).
     * @param col  The column index on the face (0 to 2, left to right).
    ...
    /**
     * Returns true if this cube position can be reached by legal moves
     * (i.e. corner twists, edge flips and permutation parity are valid).
     */
